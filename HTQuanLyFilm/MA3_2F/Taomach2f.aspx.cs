...
namespace HTQuanLyFilm.MA3_2F
{
    public partial class Taomach2f : System.Web.UI.Page
    {
        ...
        protected void txttimkiemsanpham_TextChanged(object sender, EventArgs e)
        {
            ...
            var service = new Service();
            GridView1.DataSourceID = null;
            GridView1.DataSource = service.SearchPhimPcbByMa3_2f(bophan, txttimkiemsanpham.Text.Trim(), drophientrang.Text);
            GridView1.DataBind();
            lbsoluong.Text = GridView1.Rows.Count.ToString();
        }
                ...
                else
                {
                    if (checkx && checky)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                PhimPcb.phanloai = "Làm Lại";
                                sobo = service.GetMaxSoBoPhimPcb("MA3-2F", txtsanpham.Text.Trim(), droploaiphimform.Text);
                                PhimPcb.sobo = sobo;
                                service.InsertPhimPcb(PhimPcb);
                            }
                            GridView1.DataSourceID = "dsphimpcb";
