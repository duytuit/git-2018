<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="PE_pcb.aspx.cs" Inherits="HTQuanLyFilm.PE.PE_pcb" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <div id="pnlAddPopup" runat="server" style="width: 700px; background-color: #66CC66; border-left: solid; border-left-color: black">
                    ...
                    <asp:HiddenField ID="hfhientrang" runat="server" />
                    <div>
                        <table border="0" class="table-border">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;<span class="auto-style7"><em>&nbsp;&nbsp; * Ghi rõ nội dung yêu cầu</em></span></td>
                            </tr>
                            <tr>
                                <td class="auto-style5">
                                    <asp:Label ID="Label2" runat="server" Text="Xác Nhận PE"></asp:Label></td>
                                <td>
                                    <asp:TextBox ID="txtxacnhanpe" runat="server" Height="80px" TextMode="MultiLine" Width="160px"></asp:TextBox>
                                    &nbsp;<span class="auto-style7"><em>&nbsp;&nbsp; * Ghi rõ nội dung và số điện thoại người xác nhận</em></span></td>
                            </tr>
                            <tr>
                                <td class="auto-style5">
