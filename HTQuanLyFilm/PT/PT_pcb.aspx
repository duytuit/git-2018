<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="PT_pcb.aspx.cs" Inherits="HTQuanLyFilm.PT.PT_pcb" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ObjectDataSource ID="dsphimpcb" runat="server" SelectMethod="GetPhimPcbMa4_3f" TypeName="ActionService.Service"></asp:ObjectDataSource>
    <asp:ObjectDataSource ID="dsmember" runat="server" SelectMethod="GetListMemBer" TypeName="ActionService.Service">
        <SelectParameters>
            <asp:Parameter DefaultValue="MA4-3F" Name="production" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
