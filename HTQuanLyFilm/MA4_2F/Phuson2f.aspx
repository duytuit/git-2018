<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Phuson2f.aspx.cs" Inherits="HTQuanLyFilm.MA4_2F.Phuson2f" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ObjectDataSource ID="dsloaiphim" runat="server" SelectMethod="GetLoaiPhimByBoPhan" TypeName="ActionService.Service">
        <SelectParameters>
            <asp:Parameter DefaultValue="MA4-2F" Name="bophan" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="dsphimpcb" runat="server" SelectMethod="GetPhimPcbMa4_2f" TypeName="ActionService.Service"></asp:ObjectDataSource>
    <asp:ObjectDataSource ID="dsmember" runat="server" SelectMethod="GetListMemBer" TypeName="ActionService.Service">
        <SelectParameters>
            <asp:Parameter DefaultValue="MA4-2F" Name="production" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
